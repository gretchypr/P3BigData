...
flu_total = spark.sql("select _1._c0, _2.full_text from merge where _2.full_text like '%flu%' and (_1._c0 == 0 or _1._c0 == 1)").count()
flu_total2 = spark.sql("select _1._c1, _2.full_text from merge where _2.full_text like '%flu%' and (_1._c1 == 0 or _1._c1 == 1)").count()
# Zika results
...
zika_total = spark.sql("select _1._c0, _2.full_text from merge where _2.full_text like '%zika%' and (_1._c0 == 0 or _1._c0 == 1)").count()
zika_total2 = spark.sql("select _1._c1, _2.full_text from merge where _2.full_text like '%zika%' and (_1._c1 == 0 or _1._c1 == 1)").count()
# Diarrhea results
...
dia_total = spark.sql("select _1._c0, _2.full_text from merge where _2.full_text like '%diarrhea%' and (_1._c0 == 0 or _1._c0 == 1)").count()
dia_total2 = spark.sql("select _1._c1, _2.full_text from merge where _2.full_text like '%diarrhea%' and (_1._c1 == 0 or _1._c1 == 1)").count()
# Ebola results
...
ebola_total = spark.sql("select _1._c0, _2.full_text from merge where _2.full_text like '%ebola%' and (_1._c0 == 0 or _1._c0 == 1)").count()
ebola_total2 = spark.sql("select _1._c1, _2.full_text from merge where _2.full_text like '%ebola%' and (_1._c1 == 0 or _1._c1 == 1)").count()
# Measles results
...
measles_total = spark.sql("select _1._c0, _2.full_text from merge where _2.full_text like '%measles%' and (_1._c0 == 0 or _1._c0 == 1)").count()
measles_total2 = spark.sql("select _1._c1, _2.full_text from merge where _2.full_text like '%measles%' and (_1._c1 == 0 or _1._c1 == 1)").count()
...
output3.write("flu,1," + str(flu_count3) + "," + str(flu_count4) + "," + str(flu_total2) + "\n")
output3.write("zika,0," + str(zika_count1) + "," + str(zika_count2) + "," + str(zika_total) + "\n")
output3.write("zika,1," + str(zika_count3) + "," + str(zika_count4) + "," + str(zika_total2) + "\n")
output3.write("diarrhea,0," + str(dia_count1) + "," + str(dia_count2) + "," + str(dia_total) + "\n")
output3.write("diarrhea,1," + str(dia_count3) + "," + str(dia_count4) + "," + str(dia_total2) + "\n")
output3.write("ebola,0," + str(ebola_count1) + "," + str(ebola_count2) + "," + str(ebola_total) + "\n")
output3.write("ebola,1," + str(ebola_count3) + "," + str(ebola_count4) + "," + str(ebola_total2) + "\n")
output3.write("measles,0," + str(measles_count1) + "," + str(measles_count2) + "," + str(measles_total) + "\n")
output3.write("measles,1," + str(measles_count3) + "," + str(measles_count4) + "," + str(measles_total2) + "\n")
# Get all the results
